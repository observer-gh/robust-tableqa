{
  ...
  model_config: {
    ...
    QueryEncoderModelVersion: '$ColBERT_NQTables_bz4_negative4_fix_doclen_full_search_NewcrossGPU/train/saved_model/step_5427',
    SPECIAL_TOKENS: {
      additional_special_tokens: [],
    },
    ...
    index_files: {
      embedding_path: 'ColBERT_NQTables_bz4_negative4_fix_doclen_full_search_NewcrossGPU/test/nq_tables_all/step_5427/item_embeddings.pkl',
      ...
      index_path: 'ColBERT_NQTables_bz4_negative4_fix_doclen_full_search_NewcrossGPU/test/nq_tables_all/step_5427/table_dataset_colbert_index',
    },
    input_modules: {
      module_list: [
        {
