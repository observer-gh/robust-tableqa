{
  ...
  model_config: {
    ...
    QueryEncoderModelVersion: '$DPR_E2EWTQ_train_bz8_gc_4_neg4/train/saved_model/step_480/query_encoder',
    SPECIAL_TOKENS: {
      additional_special_tokens: [],
    },
    ...
    index_files: {
      index_passages_path: 'DPR_E2EWTQ_train_bz8_gc_4_neg4/test/exhaustive_search/step_480/table_dataset',
      index_path: 'DPR_E2EWTQ_train_bz8_gc_4_neg4/test/exhaustive_search/step_480/table_dataset_hnsw_index.faiss',
    },
    input_modules: {
      module_list: [
        {
