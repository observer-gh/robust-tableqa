...
class NQTablesDataset(WikiTQDataset):
    """
    ...
    def collate_fn(self, batch):
        ...
        alternative_answers = [sample.alternative_answers for sample in batch]
...
class RAGNQTablesDataset(NQTablesDataset):
    """
...
class DPRNQTablesDataset(NQTablesDataset):
    """
